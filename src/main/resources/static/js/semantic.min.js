         ...
         e.fn.form.settings = {
          ...
          rules: {
           ...
           integer: function(t, n) {
            ...
            return n && ["", ".."].indexOf(n) === -1 && (n.indexOf("..") == -1 ? s.test(n) && (o = a = n - 0) : (r = n.split("..", 2),
            s.test(r[0]) && (o = r[0] - 0),
            s.test(r[1]) && (a = r[1] - 0))),
          ...
          return a.each(function() {
           ...
           m = {
            ...
            create: function() {
             ...
             return g.dimmerName && (m.debug("Creating named dimmer", g.dimmerName),
           ...
           k = {
            ...
            event: {
             ...
             search: {
              ...
              blur: function(e) {
               v = n.activeElement === this,
               b || Y || v || (S.forceSelection && k.forceSelection(),
                   k.hide()),
                   b = !1
              }
             },
            ...
            get: {
             ...
             choiceText: function(t, n) {
              if (n = n !== i ? n : S.preserveHTML,
                  t)
               return t.find(D.menu).length > 0 && (k.verbose("Retrieving text of element with sub-menu"),
                   t = t.clone(),
             ...
             item: function(t, n) {
              ...
              o && X.each(function() {
               ...
               if (null !== l && l !== i)
                if (a)
                 e.inArray(String(l), t) === -1 && e.inArray(s, t) === -1 || (r = r ? r.add(o) : o);
                else if (n) {
            ...
            clear: function() {
             k.is.multiple() && S.useLabels ? k.remove.labels() : (k.remove.activeItem(),
                 k.remove.selectedItem()),
                 k.set.placeholderText(),
                 k.clearValue()
            },
     ...
     e.fn.progress = function(t) {
      ...
      return a.each(function() {
       ...
       f = {
        ...
        set: {
         barWidth: function(e) {
          e > 100 ? f.error(b.tooHigh, e) : e < 0 ? f.error(b.tooLow, e) : (w.css("width", e + "%"),
             ...
             result: function(t, n) {
              ...
              return t = t !== i ? t : m.get.value(),
                  ...
                  "category" === g.type ? (m.debug("Finding result that matches", t),
                      e.each(n, function(n, i) {
                       if (e.isArray(i.results) && (a = m.search.object(t, i.results, o)[0]))
                        return !1
            ...
            set: {
             ...
             stageSize: function() {
              ...
              t.removeClass(x.active),
                  ...
                  e.insertAfter(k),
                  e.remove(),
              "auto" != h.width && (k.css("width", i + h.jitter),
                  g.verbose("Specifying width during animation", i)),
              "auto" != h.height && (k.css("height", o + h.jitter),
          ...
          return r.each(function() {
           ...
           h = {
            ...
            determineContext: function() {
             if (m = v.context ? e(v.context) : r,
             0 === m.length)
              return void h.error(x.invalidContext, v.context, k)
            },
            checkErrors: function() {
             if (h.is.hidden() && h.error(x.visible, k),
